  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-20">
          <span className="text-accent font-serif italic text-xl mb-4 block">/ High Click-Through</span>
          <h1 className="text-5xl md:text-8xl font-serif mb-8 leading-tight">Thumbnail Designs</h1>
          <p className="text-2xl text-ink-muted max-w-3xl leading-relaxed font-serif italic">
            Strategic thumbnails designed to maximize clicks and viewer engagement.
          </p>
        </div>
        ...
        <div className="text-center py-20 border-t border-ink/5">
          <h2 className="text-4xl md:text-6xl font-serif mb-10">Want more clicks?</h2>
          <button 
            onClick={openModal}
